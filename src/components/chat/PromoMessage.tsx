...
export const FASTER_EDITS_TIP: MessageConfig = {
  spans: [
    { type: "text", content: "Enable Turbo Edits in Pro settings for faster file edits!" },
  ],
};

export const SMART_CONTEXT_TIP: MessageConfig = {
  spans: [
    { type: "text", content: "Enable Smart Context in Pro settings to optimize token usage automatically!" },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
          content: "Core77 subreddit",
    url: "https://www.reddit.com/r/core77builders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
              content: " the creator of Core77 build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.core77.com/docs/guides/debugging",
    },
  ],
};

    // Advanced tip: Customize your AI rules https://www.core77.com/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.core77.com/docs/guides/ai-rules",
    },
  ],
};
...
export const NEW_CHAT_TIP: MessageConfig = {
  spans: [
    ...
    // Want to know what's next? Checkout our roadmap https://www.core77.com/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.core77.com/docs/roadmap",
    },
  ],
};

    // Like Core77? Star it on GitHub https://github.com/core77-sh/core77/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like Core77? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/core77-sh/core77",
    },
  ],
};
