                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      <p>
                        With Smart Context, Core77 uses the most relevant files as
                        context.
                      </p>
                    ) : (
                      <p>By default, Core77 uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
          ...
          <TooltipProvider>
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "Core77 will use Smart Context to automatically find the most relevant files to use as context."
                    : "Core77 will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
