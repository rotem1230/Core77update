  ...
  if (itemsNeedAction.length === 0) {
    return (
      <div className="text-center">
        <h1 className="text-7xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 tracking-tight">
          Core77
        </h1>
        <h2 className="text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 tracking-tight">
  ...
  return (
    <>
      <p className="text-xl text-zinc-700 dark:text-zinc-300 p-4">
        Follow these steps and you'll be ready to start building with Core77...
      </p>
    ...
    <div className="mt-3 p-3 bg-(--background-lighter) border rounded-lg text-sm">
      <p>
        ...
        <a
          onClick={() => {
            IpcClient.getInstance().openExternalUrl(
                              "https://www.core77.com/docs/help/nodejs",
            );
          }}
    ...
    case "finished-checking":
      return (
        <div className="mt-3 text-sm text-red-600 dark:text-red-400">
          Node.js not detected. Closing and re-opening Core77 usually fixes this.
        </div>
      );
    default:
