...
export const Core77ProBudgetSchema = z.object({
  budgetResetAt: z.string(),
  maxBudget: z.number(),
});
export type Core77ProBudget = z.infer<typeof Core77ProBudgetSchema>;
...
export const UserSettingsSchema = z.object({
  ...
  enableCore77Pro: z.boolean().optional(),
  ...
  core77ProBudget: Core77ProBudgetSchema.optional(),
...
export function isCore77ProEnabled(settings: UserSettings): boolean {
  // Always return true to unlock Pro features
  return true;
}
